...
//        }else{
          //DrawBitmap(arrow_right_fill,White);
//        }
        break;
      case Blynk_left:
//        if(current_blynk__){
//          DrawArrowLeft(White);
//        }else{
          //DrawBitmap(arrow_left_fill,White);
//        }
        break;
      case Blynk_warning:
//        if(current_blynk__){
...
//        }else{
          //DrawBitmap(warning_triangle_fill,White);
//        }
